...
class App extends Component {
  ...
  render() {
    ...
    if(this.state.loading) {
      if(this.state.noEth) {
        content = <div className="card mb-4" ><div className="card-body"><p id="loader" ><WaveTopBottomLoading color={"#2c91c7"} /><a href="https://metamask.io/"><h5><strong>Install MetaMask!</strong></h5><img alt="MetaMask" width="89.6%" height="auto" src={require("../mm.png")} /></a></p></div></div>
      } else {
